...
var index=function(){var o,t,a=e=>{let o;switch(e){case"1":o=0;break;case"2":o=111;break;case"3":o=250}(t=gsap.timeline({paused:!0})).add(()=>{var e=document.querySelectorAll(".planet"),o=document.querySelectorAll(".nav");for(const t of e)t.classList.remove("active");for(const a of o)a.classList.remove("active")}).add(()=>{document.querySelector(".nav-"+e).classList.add("active")}).to(".who_we_empower .slide",{duration:.5,autoAlpha:0}).to(".orbit-5 .planets",{duration:1,rotation:o}).add(()=>{document.querySelector(".planet-"+e).classList.add("active")},1.5).to(".who_we_empower .slide-"+e,{duration:.5,autoAlpha:1},1.5),t.play()},e=()=>{gsap.set("#nav .close",{display:"none"}),gsap.set(menu,{autoAlpha:0,yPercent:-100}),o=gsap.timeline({repeat:-1,repeatDelay:5}),gsap.to(".orbit-3 .planets",{duration:180,repeat:-1,rotation:360,ease:"none"}),gsap.to(".orbit-4 .planets",{duration:120,repeat:-1,rotation:360,ease:"none"}),gsap.set(".who_we_empower .slide",{autoAlpha:0}),o.add(()=>{a("1")},0).add(()=>{a("2")},5).add(()=>{a("3")},10),new Swiper(".swiper",{slidesPerView:"auto",spaceBetween:16}),(()=>{const e=gsap.timeline({repeat:-1});e.from(".tips .icon",{duration:1,yPercent:-100,ease:"power3.out"}).to(".tips .icon",{duration:1,yPercent:100,ease:"power3.in"})})(),768<=window.innerWidth&&(document.querySelector(".intro video").src="video/intro-video.mp4",document.querySelector(".our_vision_and_mission video").src="video/ovam-video.mp4")};return{init:()=>{e()},menu:e=>{(e=>{let o,t,a;a=e?(o=0,t="none","inline-flex"):(o=-100,t="inline-flex","none"),gsap.to(menu,{duration:.3,yPercent:o,autoAlpha:1}),gsap.set("#nav .menu",{display:t}),gsap.set("#nav .close",{display:a})})(e)},goto:()=>{document.querySelector(".follow_us").scrollIntoView({behavior:"smooth",block:"center"})},slide:e=>{o.pause(),t.pause(),a(e)}}}();